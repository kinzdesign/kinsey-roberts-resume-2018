...
INSERT INTO `bullets` VALUES
  (4,16,'Trained a team of 3-6 student employees on network/<abbr title=\"hardware\">HW</abbr>/<abbr title=\"software\">SW</abbr> troubleshooting and user support',2),
  ...
  (9,15,'Communicated with and observed end users to ease pain points and discover new <abbr title=\"software\">SW</abbr> optimizations',5),
  ...
  (11,2,'Promoted from Software Developer to reflect skills and experience gained and improved performance',1),
  ...
  (14,3,'Contributed to epilepsy research in transgenic mice at the Neural Engineering Center in <abbr title=\"Biomedical Engineering department\">BME</abbr>',2),
  ...
  (27,1,'Collaborated with marketing and admissions to imagine, design, and execute web and email campaigns',NULL),
